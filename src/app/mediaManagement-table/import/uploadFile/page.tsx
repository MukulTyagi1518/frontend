...
export default function ImportPage() {
  ...
  <path d="M13 5H4C2.89543 5 2 5.89543 2 7V17C2 18.1046 2.89543 19 4 19H13C14.1046 19 15 18.1046 15 17V7C15 5.89543 14.1046 5 13 5Z" fill="#FAFAFA"/>
  <path d="M21.5 6.3C21.3485 6.21132 21.1763 6.16408 21.0008 6.16302C20.8253 6.16197 20.6525 6.20714 20.5 6.294L17 8.284V15.817L20.465 18.017C20.6166 18.113 20.7912 18.1664 20.9706 18.1717C21.15 18.177 21.3275 18.1339 21.4844 18.047C21.6414 17.9601 21.7721 17.8325 21.8628 17.6777C21.9535 17.5228 22.0009 17.3464 22 17.167V7.167C22.0002 6.9913 21.954 6.81865 21.8663 6.66645C21.7785 6.51424 21.6522 6.38785 21.5 6.3Z" fill="#FAFAFA"/>
</svg>
        ...
        <div className="border border-gray-600 rounded-md">
          ...
          {/* Progress Bar */}
          <div className="relative flex items-center pt-6 p-4 border-t border-gray-600">
            <span className="text-sm text-green-700">Choose Destination</span>
            <div className="flex-grow h-px bg-green-700 mx-4"></div>
          ...
          {/* <div className="px-4 py-3">
            <select className="bg-gray-800 text-white border border-gray-600 rounded-md px-4 py-2">
          ...
          {/* <div className="px-4 py-2 text-white text-[24px] flex items-center space-x-4">
            ...
            <span className="text-neutral-500">› Sub Folder</span>
          </div> */}

          {/* Create Folder Button */}
          {/* <div className="flex justify-end px-4 py-3">
            <Button className="bg-gray-800 text-white hover:bg-gray-700 flex items-center space-x-2">
          ...
          <div>
            <div className="flex items-center justify-center w-[600px]   m-auto py-20">
              <label
                ...
                className="flex flex-col h-[400px] items-center justify-center w-full h-64 border-2 border-neutral-600 border-dashed rounded-lg cursor-pointer bg-neutral-800 hover:bg-neutral-700"
              >
                <div className="flex flex-col items-center  justify-center pt-5 pb-6">
                  ...
                  <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                    <span className="font-semibold">Click to upload meta data</span> or
                    drag and drop
                  </p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    XXL, XLSX or  CSV (MAX. 30 MB)
                  </p>
                </div>
                <input
                  id="dropzone-file"
