...
// export default function NestedCreateMediaPage() {
...
//   const [videoFileName, setVideoFileName] = useState<string>("No video chosen");
//   const [thumbnailFileName, setThumbnailFileName] = useState<string>(
//     "No thumbnail chosen"
//   );
//   const [canProceed, setCanProceed] = useState<boolean>(false);

//   // Fetch current date and time for "Created At"
//   useEffect(() => {
...
//     const format = searchParams.get("mediaFormat") || "";
//     setMediaType(type);
...
//         });
//         setVideoFile(null);
//         setVideoFileName("No video chosen");
//       }
//     }
//   };
...
//           type: "error",
//           title: "Invalid File",
//           description: "Please select a valid image file for thumbnail.",
//         });
//         setThumbnailFile(null);
//         setThumbnailFileName("No thumbnail chosen");
//       }
//     }
//   };
...
//       // Step 1: Generate presigned URL for video
//       const presignedUrlResponse = await axios.post(
//         `${API_URL}/fitnearn/web/admin/uploadMediaData/generatePresignedUrls`,
//         {
...
//       // Step 2: Upload video using presigned URL
...
//         // Initialize an object with default empty string values for all fields
//         const errorMap: {
//           mediaName: string;
...
//         // Populate errorMap with messages from ZodError
//         err.issues.forEach((issue) => {
//           const key = issue.path[0] as keyof typeof errorMap;
//           if (key in errorMap) {
//             errorMap[key] = issue.message;
//           }
//         });
//         // router.push("/mediaManagement-table");
//         setErrors(errorMap); // Pass the properly structured object to setErrors
//       } else {
...
//     setShowDeletePopup(false); // Close popup after confirmation
//     router.push("/mediaManagement-table"); // Redirect to media table
//   };

//   const navigateToForm = () => {
//     // Pass state as query parameters
//     setNavigatedToForm(true);
//     router.push(
//       `/mediaManagement-table/create/videoUpload/form?mediaType=${mediaType}&mediaFormat=${mediaFormat}`
//     );
//   };
//   return (
...
//                         onClick={() => setShowDeletePopup(true)} // Open popup
//                       >
//                         Delete
//                       </button>
//                     </div>
...
//                     <span className="text-sm font-medium text-[#0E9F6E]">
//                       Upload Media
//                     </span>
//                     <div
...
//                       <SelectTrigger
//                         id="categories"
//                         className="w-full border border-gray-600 rounded-md text-gray-400"
//                       >
//                         <SelectValue placeholder="Select Category" />
//                       </SelectTrigger>
//                       <SelectContent>
//                         <SelectItem value="1920x1080">Yoga</SelectItem>
//                         <SelectItem value="1280x720">Meditation</SelectItem>
//                         <SelectItem value="1024x768">Cardio</SelectItem>
//                         <SelectItem value="800x600">Kick Boxing</SelectItem>
//                       </SelectContent>
//                     </Select>
//                     {errors.category && (
...
//                       <div
//                         className="flex items-center justify-between p-1.5 text-gray-400 border border-gray-600 rounded-md cursor-pointer"
//                         onClick={() =>
//                           setDeviceTypeDropdownOpen((prev) => !prev)
//                         }
//                       >
...
//                         <ul className="absolute z-10 mt-2  w-full overflow-auto rounded-md bg-neutral-950 border  text-white shadow-lg ring-1 ring-black ring-opacity-5">
//                           {deviceTypes.map((device) => (
//                             <li
//                               key={device}
//                               className="px-4 py-2 cursor-pointer hover:bg-neutral-800"
//                               onClick={() => {
//                                 setSelectedDeviceType(device); // Set the selected device type
//                                 setDeviceTypeDropdownOpen(false); // Automatically collapse dropdown
//                               }}
//                             >
//                               {device}
//                             </li>
...
//                         setErrors((prev) => ({ ...prev, mediaDimensions: "" }));
//                       }}
//                     >
//                       <SelectTrigger
//                         id="media-dimension"
...
//                 {/* Submit Button */}
//                 {/* <Link href="/mediaManagement-table"> */}
...
//                     />
//                     <span className="flex-grow text-gray-400 bg-black h-full flex items-center rounded-[5px] px-[10px] py-[8px]">
//                       {videoFileName}
//                     </span>
//                   </div>
//                 </div>

//                 {/* Thumbnail Upload - Only show after video is selected */}
//                 {videoFile && (
//                   <div className="mb-4">
//                     <label className="block text-sm font-medium text-gray-400">
...
//               {/* Next Button - Only enable when both files are selected */}
