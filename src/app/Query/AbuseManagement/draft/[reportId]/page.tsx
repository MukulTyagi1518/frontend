    ...
    const fetchSessionData = async () => {
      ...
      try {
        const response = await fetch(
          `${apiendpoint2}/live-session/get-session/${sessionId}`
        );
  ...
  <div className="container mx-auto py-10 pt-10 pr-10 pl-[60px]">
        ...
        <div className="mb-4 text-sm text-gray-500 flex items-center space-x-2">
          <button
            ...
            onClick={() => router.push("/Query/AbuseManagement")}
          >
            <svg
            ...
            <span>Report Abuse Management</span>
          </button>
          <span className="text-lg text-white">›</span>
          <span className="text-lg text-white">Report Abuse Management</span>
        </div>
        ...
        <div className="border border-[#525252] rounded-lg">
          ...
          <div className="flex items-center w-full justify-between px-6 py-4 border-b border-[#525252]">
            ...
            <div className="ml-auto flex items-center space-x-4">
              ...
              <Button
                className="bg-neutral-800 text-[#FAFAFA] flex items-center space-x-2 hover:bg-gray-700"
                onClick={() => handleSaveOrReview(true)} // Pass true for Save
              >
              ...
              <div className="relative">
                <Button
                  ...
                  onClick={() => setDropdownOpen({ type: "TOGGLE" })} // Toggle dropdown visibility
                >
                  <MoreHorizontal className="h-6 w-6 text-white" />
                </Button>
                {dropdownOpen && ( // Render dropdown only when open
                  <div className="absolute right-0 mt-2 w-40 bg-[#262626] border border-gray-600 rounded-md shadow-lg text-white z-50">
                    <button
            ...
            <div className="grid grid-cols-2 gap-x-32 gap-y-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-[#262626] text-gray-400 border border-gray-600 p-2 rounded"
                />
              </div>
              ...
              <div className="col-span-2">
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  value={
                    sessionDetails.description || sessionData?.description || ""
                  }
                  className={`mt-2 w-full p-2 resize-none focus:outline-none border rounded-[8px] ${
                    isEditing
                      ? "bg-neutral-950 text-gray-300 border-gray-600 focus:border-gray-400"
                      : "bg-[var(--Neutral-800,#262626)] text-gray-500 border-[var(--Neutral-600,#525252)]"
                  }`}
                  rows={4}
                  readOnly={!isEditing}
                />
