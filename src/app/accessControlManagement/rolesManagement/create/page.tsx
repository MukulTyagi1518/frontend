...
export default function AccessControlManagementPage() {
  ...
  const handleSelectionChange = (selectedIds: string[]) => {
    setSelectedPermission([...selectedIds]); // Store selected IDs as an array
  };
    ...
    const fetchRoleData = async () => {
      try {
        const response = await fetch(
          `${API_URL}/fitnearn/web/admin/access/role/get-all`
        );
        ...
        if (data.success) {
          ...
          const formattedPermissions = data.data.flatMap((role) =>
  ...
  const handleCreateRole = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/fitnearn/web/admin/access/role/add`,
        {
          method: "POST",
          headers: {
            ...
            <div className="space-y-6 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2 w-2/3">
                  ...
                  <Input
                    ...
                    className="bg-neutral-950 border-zinc-800 w-full"
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  className="bg-neutral-950 border-zinc-800 min-h-[40px]"
                />
              </div>
              ...
              <div className="flex items-center justify-end">
                <Button
                  ...
                  disabled={isSaving}
                  className="  flex items-center space-x-2 hover:bg-neutral-300"
                >
