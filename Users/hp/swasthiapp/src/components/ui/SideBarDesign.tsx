...
//   accessControlManagementbg?: string;
//   queryfill?: string;
//   querytext?: string;
//   videobg?: string;
//   videofill?: string;
...
//   workoutbg?: string;
//   blogbg?: string;
//   postmanagementbg?: string;
//   bookingsbg?: string;
//   accessControl1bg?: string;
// }
// interface SidebarDesignProps {
//     accessControl3bg?: string;
//     accessControl3text?: string;
//     accessControl4bg?: string;  // ✅ Add this
//     accessControl4text?: string;
//     accessControl2text?:string; 
//     accessControl1text?:string;
//     accessControl2bg?:string;
//      // ✅ Add this
...
//                 {...commonProps}
//                 placeholder=""
//                 style={{ backgroundColor: props.workoutbg }}
//                 className={`border-b-0 p-2  rounded-lg ml-2`}
//                 onClick={() => {
//                   router.push("/workoutManagement");
//                 }}
//               >
//                 <svg
//                   xmlns="http://www.w3.org/2000/svg"
...
//                 {...commonProps}
//                 placeholder=""
//                 style={{ backgroundColor: props.postmanagementbg }}
//                 className={`border-b-0 p-2 rounded-lg ml-2`}
//                 onClick={() => {
...
//                 {...commonProps}
//                 placeholder=""
//                 style={{ backgroundColor: props.bookingsbg }}
//                 className={`border-b-0 p-2 rounded-lg ml-2`}
//                 onClick={() => {
//                   router.push("/bookingManagement/table");
//                 }}
//               >
//                 <svg
//                   xmlns="http://www.w3.org/2000/svg"
...
//                 {...commonProps}
//                 placeholder=""
//                 style={{ backgroundColor: props.blogbg }}
//                 className={`border-b-0 p-2 rounded-lg ml-2`}
//                 onClick={() => {
//                   router.push("/sessionmanage/sessiontable");
//                 }}
...
//                 {...commonProps}
//                 placeholder=""
//                 style={{ backgroundColor: props.mediaManagementbg }}
//                 onClick={() => {
...
//               <AccordionHeader
//                 {...commonProps}
//                 style={{ backgroundColor: props.accessControlManagementbg }}
//                 placeholder=""
...
//                   placeholder=""
//                   color="white"
//                   className={`mr-[30px] text-nowrap text-${
...
//                 <ListItem
//                   {...commonProps}
//                   style={{ backgroundColor: props.accessControl1bg }}
//                   placeholder=""
//                   className={`border-b-0 p-3 rounded-lg`}
//                 >
//                   <ListItemPrefix {...commonProps} placeholder="">
...
//                   <span
//                     onClick={() => {
//                       router.push("/accessControlManagement/adminUser/table");
//                     }}
//                     className={`mr-auto text-${
//                       props.accessControl1text || "white"
//                     } font-normal `}
//                   >
//                     Profile Management
//                   </span>
...
//                 <ListItem
//                   {...commonProps}
//                   style={{ backgroundColor: props.accessControl2bg }}
//                   placeholder=""
//                   className={`border-b-0 p-3 rounded-lg`}
//                 >
//                   <ListItemPrefix {...commonProps} placeholder="">
...
//                     }}
//                     className={`mr-auto text-${
//                       props.accessControl2text || "white"
//                     } font-normal `}
//                   >
//                     Group Management
//                   </span>
...
//                 <ListItem
//                   {...commonProps}
//                   style={{ backgroundColor: props.accessControl3bg }}
//                   placeholder=""
//                   className={`border-b-0 p-3 rounded-lg`}
//                 >
//                   <ListItemPrefix {...commonProps} placeholder="">
...
//                     onClick={() => {
//                       router.push(
//                         "/accessControlManagement/permissionManagement/table"
//                       );
//                     }}
//                     className={`mr-auto text-${
//                       props.accessControl3text || "white"
//                     } font-normal `}
//                   >
...
//                 <ListItem
//                   {...commonProps}
//                   style={{ backgroundColor: props.accessControl4bg }}
//                   placeholder=""
//                   className={`border-b-0 p-3 rounded-lg`}
//                 >
//                   <ListItemPrefix {...commonProps} placeholder="">
...
//                     onClick={() => {
//                       router.push(
//                         "/accessControlManagement/rolesManagement/rolesTable"
//                       );
//                     }}
//                     className={`mr-auto text-${
//                       props.accessControl4text || "white"
//                     } font-normal `}
//                   >
//                     Role Management
//                   </span>
